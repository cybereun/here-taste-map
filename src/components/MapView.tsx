    ...
    if (currentEngine === 'naver') {
      const initNaver = () => {
        ...
        try {
          ...
          console.warn('[MapView] Naver map init failed, switching to Leaflet:', err);
  ...
  return (
    <div className="relative w-full h-full flex-1">
      ...
      >
        ...
        <span>{currentEngine === 'naver' ? '네이버 지도 ON' : '기본 지도 (정상작동)'}</span>
      </button>
